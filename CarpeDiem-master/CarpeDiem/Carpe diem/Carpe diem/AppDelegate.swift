...
class AppDelegate: UIResponder, UIApplicationDelegate, NSFetchedResultsControllerDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        UITabBar.appearance().tintColor = UIColor(red: 0.97, green: 0.77, blue: 0.17, alpha: 1.0)
        ...
        var initialViewController = storyboard.instantiateViewController(withIdentifier: "ViewControllerPrimo")
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Carpe_diem")
